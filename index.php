  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row justify-content-center">
        <h1 class="section-title text-center mt-4" data-aos="fade-up">New Releases</h1>
        ...
        <div class="row">
            ...
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="index.php" class="btn btn-common text-uppercase">Shop for men</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="index.php" class="btn btn-common text-uppercase">Shop for women</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="index.php" class="btn btn-common text-uppercase">Shop accessories</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          ...
          <div class="col-md-6 column-container bg-white">
            <div class="collection-content p-4 m-0 m-md-5">
              <h3 class="element-title text-uppercase">Classic Gaming Set</h3>
              <p>Revive the golden age of gaming with our Classic Gaming Set! Featuring iconic titles and retro consoles that defined an era, this collection is perfect for both seasoned gamers and newcomers alike. Experience the thrill of pixelated adventures, epic battles, and classic platforming challenges that shaped the gaming landscape. Whether you’re reliving cherished memories or discovering timeless classics for the first time, the Classic Gaming Set promises hours of fun and excitement. Grab your friends, dust off those controllers, and embark on an unforgettable journey through gaming history!</p>
